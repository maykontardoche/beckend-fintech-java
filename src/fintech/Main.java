...
public class Main {
    public static void main(String[] args) {
        // Criando um cliente
        Cliente cliente1 = new Cliente(1, "Maria Silva", "123.456.789-00", "maria.silva@email.com");
        ...
        Transacao transacao1 = new Transacao(1, new Date(), 1500.0, "Depósito");
        transacao1.processarTransacao();
        
        // Realizando um investimento
        Investimento investimento1 = new Investimento(1, "Renda Fixa", 10000.0, 0.05);
